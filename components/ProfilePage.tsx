...
const ProfilePage: React.FC<ProfilePageProps> = ({ userId, initialUser, onUpdate, isReadOnly = false, onBack }) => {
  ...
  const [profile, setProfile] = useState<UserProfile>({
    ...
    role: initialUser.role || (initialUser.profile_type === 'company' ? 'Investor' : 'Founder & Product Designer'),
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  {!isReadOnly && (
                    <div className="sm:col-span-2 mt-4 p-6 bg-[#0f172a]/30 border border-gray-800 rounded-2xl">
                      <label className="block text-white font-bold mb-4">Are you an investor?</label>
                      ...
                      {tempProfile.is_investor && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in">
                          ...
                          <div className="sm:col-span-2">
                            <label className={labelStyles}>What type of investor are you?</label>
                            <select 
                              className={inputStyles}
