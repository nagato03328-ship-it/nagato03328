...
const ForInvestors: React.FC<ForInvestorsProps> = ({ onBack, isDark }) => {
  return (
    <div className="flex-grow pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          >
            IdeaConnect bridges the gap between visionary creators and strategic investors. 
        ...
        <div className="bg-indigo-600 rounded-3xl p-12 text-white mb-20 overflow-hidden relative">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-12 text-center">How It Works for Investors</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                { step: "03", title: "Connect", desc: "Directly message creators to discuss vision, roadmap, and terms." },
        ...
        <div className="text-center mb-20">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12">Why Top Investors Choose Us</h2>
        ...
        <div className="text-center bg-gray-50 dark:bg-[#0A1025] rounded-3xl p-12 border border-gray-100 dark:border-gray-800">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Join our network of 2,000+ angel investors and VCs. Get exclusive access to high-potential projects.
          </p>
