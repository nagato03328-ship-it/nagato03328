  ...
  return (
    <section className="bg-slate-50 dark:bg-[#080D1D] py-16 lg:py-24 transition-colors duration-300">
      <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Right Column: Mockup */}
        <div className="relative p-8 bg-white dark:bg-[#182137] rounded-lg shadow-lg dark:shadow-xl animate-fade-in-right border border-gray-100 dark:border-transparent">
